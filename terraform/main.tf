...
resource "aws_s3_bucket" "terraform_state_bucket" {
  bucket = "cicd-app-sample-terraform-state-bucket-${terraform.workspace}"
  acl    = "private"
...
terraform {
  backend "s3" {
    bucket = "cicd-app-sample-terraform-state-bucket-${terraform.workspace}"  ## actual bucket name
...
resource "aws_ecr_repository" "app_repo" {
  name                 = "cicdapprepo${terraform.workspace}"
...
resource "aws_instance" "ubuntu_instance" {
  ...
  tags = {
    Name = "cicd-ec2-${terraform.workspace}"
  }
